...
?>
			<div class="maindiv" style="color:white;">
				...
				<form class="cmxform" id="commentForm" action= "search_list.php" method="POST">
					...
					<br><br>
					<button type="submit" value="finish" class="button_login" style="color:white;">搜尋</button><br><br>
					<button value="back" class="button_login" style="color:white;" onclick="javascript:location.href='search.php'">重新搜尋</botton><br>
